...
public class DBInit implements CommandLineRunner {
    ...
    private void initCategories() {
        ...
        CategoryEntity football = new CategoryEntity(CategoryEnum.FOOTBALL);
        CategoryEntity tennis = new CategoryEntity(CategoryEnum.TENNIS);
        CategoryEntity basketball = new CategoryEntity(CategoryEnum.BASKETBALL);
        CategoryEntity volleyball = new CategoryEntity(CategoryEnum.VOLLEYBALL);


        this.categoryRepository.saveAll(List.of(football, tennis, basketball, volleyball));
    ...
    private void initNews() {
        ...
        first.
                ...
                setAuthor(userRepository.findByUsername("root").get()).
                ...
                setImageUrl("https://res.cloudinary.com/dhrjhgp37/image/upload/v1616923540/g1by5h2fmqzpxtouzbhl.jpg");
        ...
        second.
                ...
                setCategory(this.categoryRepository.findByName(CategoryEnum.FOOTBALL).get()).
                setViews(0).
                setTitle("Borussia Dortmunds U23 festigt mit einem Sieg beim FC Wegberg-Beeck").
                setImageUrl("https://res.cloudinary.com/dhrjhgp37/image/upload/v1616056395/jybwfuupunhc8727tvwk.jpg").
        ...
        third.
                ...
                setImageUrl("https://res.cloudinary.com/dhrjhgp37/image/upload/v1616619877/jl5llnr9hudkhtdup4bc.jpg");
